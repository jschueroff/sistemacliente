...
//*****************************************************************************
// Metodo que mostra os dados cadastrados do banco
//
...
//*****************************************************************************
// Metodo que mostra os cliente so banco de dados e mostra na tela
//
function carregarCliente( obj ) {
	...
	xhttp.onreadystatechange = function() {
    	if (this.readyState == 4 && this.status == 200) {
      		...
      		document.getElementById('image').src 		= "/crud-master/imagens/"+resultado[0].foto;
...
//*****************************************************************************
// Metodo mostra a opção de exclusão dos dados do sistema
//
...
//*****************************************************************************
// Metodo de cadastro e atualização dos dados 
//
function salvarForm() {
	var xhttp;
	xhttp = new XMLHttpRequest();
	xhttp.onreadystatechange = function() {
    	if (this.readyState == 4 && this.status == 200) {
    		...
    		//mostrar na tela os dados atualizados com sucesso
      		document.getElementById('msg-php').innerHTML = this.responseText;
      		document.getElementById('msg-php').classList.remove("no-display");
      		document.getElementById('msg-php').classList.add("msg-php");
      		hideMsg();
...
//*****************************************************************************
// Metodo que esconde as mensagens na tela
//
function hideMsg() {
	setTimeout(function() {
